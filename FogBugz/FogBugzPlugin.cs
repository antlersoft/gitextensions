...
namespace FogBugz
{
  public class FogBugzPlugin : GitPluginBase
  {
    ...
    {
      Name = "FogBugz";
      Description = "FogBugz case associated with commit";
    }
    ...
    {
      _menuItem.Enabled = _grid.GetSelectedRevisions().Any(gr => BugzPattern.IsMatch(gr.Subject + gr.Body));
    }
    ...
    private void _menuItem_Click(object sender, EventArgs e)
    {
      ...
      {
        var match = BugzPattern.Match(gr.Subject + gr.Body);
        if (match.Success)
        {
